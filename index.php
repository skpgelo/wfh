...
<div class="container py-5">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">PELAKSANAAN TUGAS POKJA LAYANAN SOSIAL SUB POKJA DSM DAN PENDAMPINGAN SOSIAL</h5>
            <h5 class="mb-0">KOORDINATOR DESA SEJAHTERA MANDIRI (DSM)</h5>
            <h6 class="mb-0"><p id="tanggal"></p></h6>
        </div>
        <div class="card-body">
            <form id="wfhForm">
                <div class="row g-3">
